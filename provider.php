...
$cities = ["Amritsar","Amravati","Bangalore","Chennai","Delhi","Dharwad","Guntur","Goa","Hyderabad","Hubli","Jaipur","Kolkata","Lucknow","Mangalore","Mumbai","Nagpur","Ongole","Raichur","Srinagar","Surathkal","Warangal"];
?>
        ...
        <div class="card-body">
            ...
            <form action="scripts/updatehall.php" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <option value="washingMachineRepair">Washing Machine Repair</option>
